...
<template>
  <div class="consult-fast-page">
    ...
    <div class="fast-type">
      <router-link to="/consult/dep" class="item" @click="store.setIllnessType(IllnessType.three)">
      ...
      <router-link to="/consult/dep" class="item" @click="store.setIllnessType(IllnessType.ordinary)">
